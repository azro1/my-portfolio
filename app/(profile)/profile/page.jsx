...
const Profile = async () => {
  ...
  return (
      <div className='flex-1 flex flex-col gap-6 overflow-y-scroll hide-scrollbar h-profile-page-height'>
        ...
        {/* <div className="border-2 border-secondary w-11/12"></div> */}


        <div className="bg-secondary p-4 pt-10">
            <h2 className='text-2xl text-shade font-b'>Activity Feed</h2>
            <p className='mt-3 text-base text-primary font-b leading-normal'>Shows your recent activity on the website, including projects viewed, favourite projects and comments.</p>
