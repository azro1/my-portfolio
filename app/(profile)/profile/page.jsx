      ...
      <div className='overflow-y-scroll hide-scrollbar h-[90vh] pt-40 px-[x-pad] xl:pt-36'>
        ...
        {user && (
          <div className="pt-16">
            ...
            <p className='leading-normal text-charcoalGrayLight mt-2'>Your recent activity on the website, including any projects you have viewed, your favourite projects and your chat history.</p>
