        ...
        <div>
            <ul>
                <li className='flex gap-3 pb-3'>
                    <FiPhone size={20} className='text-saddleBrown' aria-label='Phone' />
                    <p>+447455 132 994</p>
                </li>
                <li className='flex gap-3 pb-3'>
                    <FiMail size={20} className='text-saddleBrown' aria-label="Email" />
                    <p>azro1.development@gmail.com</p>
                </li>
                <li className='flex gap-3 pb-3'>
                    <FiMapPin size={20} className='text-saddleBrown' aria-label="Address" />
                    <p>Sienna Court, New Southgate, London N11 2RG</p>
                </li>
            </ul>

            <div className='mt-1 relative h-44 w-full sm:w-4/5 md:w-full border-[1px] border-ashGray rounded-md'>
