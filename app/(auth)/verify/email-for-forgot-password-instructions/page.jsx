  ...
  return (
    <main className='mb-4.5'>
      <div className="flex flex-col items-center justify-center text-center min-h-custom-md">
        ...
        <p className='text-base leading-8'>To reset your password, please check your email for the verification link. Click on the link to proceed with resetting your password.</p>
      </div>
    </main>
  )
}
