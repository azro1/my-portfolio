...
export default async function AuthLayout ({ children }) {
  ...
  return (
    <main>
      <div className="min-h-custom-lg flex flex-col gap-20 md:gap-8">
          ...
          <div className='hidden lg:flex items-center gap-12'>
            <Link href='/signup'>
              <div className="tooltip group">
                <FaSignInAlt className="text-stoneGray group-hover:text-deepOlive transition duration-300 cursor-pointer" size={31} />
                <span className="tooltiptext -left-2.5">Sign up</span>
              </div>
            </Link>
            <Link href='/login'>
              <div className="tooltip group">
                <FaUserPlus className="text-stoneGray group-hover:text-deepOlive transition duration-300 cursor-pointer" size={33} />
