          ...
          <div className='hidden lg:flex items-center gap-12'>
            <Link href='/signup'>
              <div className="tooltip group">
                <FaSignInAlt className="text-stoneGray group-hover:text-accentRed transition duration-300 cursor-pointer" size={31} />
                <span className="tooltiptext -left-2.5">Sign up</span>
              </div>
            </Link>
            <Link href='/login'>
              <div className="tooltip group">
                <FaUserPlus className="text-stoneGray group-hover:text-accentRed transition duration-300 cursor-pointer" size={33} />
