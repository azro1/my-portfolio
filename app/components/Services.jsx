    ...
    <section className="mt-8.375">
      <div>
        <div className="flex flex-col items-center md:flex md:flex-row md:items-center mb-6.25">
          ...
          <div className="flex flex-col items-center text-center pt-5 md:flex md:flex-col md:items-start md:text-left md:ml-2.375">
        ...
        <div className="flex flex-col items-center md:flex md:flex-row-reverse md:items-center mb-6.25">
          ...
          <div className="flex flex-col items-center text-center pt-5 md:flex md:flex-col md:items-start md:text-left md:mr-2.375">
