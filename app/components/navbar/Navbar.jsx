...
const Navbar = ({ user }) => {
  ...
  return (
    <div className='relative'>
      <nav className={`grid grid-cols-[minmax(200px,_1fr)_minmax(40px,_40px)] ${user ? 'grid-rows-[minmax(152px,_auto)_minmax(90px,_90px)]' : 'grid-rows-[minmax(152px,_auto)]'} md:grid-cols-[minmax(200px,_1fr)_minmax(70px,_70px)_minmax(40px,_40px)] md:grid-rows-[minmax(152px,_1fr)] md:gap-3 xl:grid-cols-[minmax(200px,_1fr)_minmax(70px,_70px)]`}>
        ...
        <div className='col-start-2 row-start-1 place-self-center md:col-start-3 xl:hidden'>
          <Chevron user={user} />
        </div>
