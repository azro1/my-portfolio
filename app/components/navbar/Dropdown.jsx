    ...
    <div className='menu-links lg:hidden flex flex-col absolute w-60 right-0 top-32 p-3 bg-primary z-50 border border-secondary'>
      ...
      {user && (
        <>
          ...
          <Link href='/contact'>
            <div className='flex items-center p-3 group hover:bg-gray-800' onClick={handleCloseMenu}>
              <FaUser className="group-hover:text-hint transition duration-300" size={17} />
              <span className='text-secondary font-b ml-3.5'>Contact</span>
            </div>
          </Link>
          <div onClick={handleLogout}>
            <div className='flex items-center p-3 group hover:bg-gray-800' onClick={handleCloseMenu}>
              <FaSignOutAlt className="group-hover:text-hint transition duration-300 text-secondary" size={19} />
