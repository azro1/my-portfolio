    ...
    <>
      ...
      <Link href='/login'>
        <div className='flex items-center p-3 mb-1 bg-primary group hover:bg-white' onClick={handleCloseMenu}>
          ...
          <span className='text-secondary group-hover:text-primary text-sm font-b ml-3.5'>Login</span>
        </div>
      </Link>
      <Link href='/signup'>
        <div className='flex items-center p-3 mb-1 bg-primary group hover:bg-white' onClick={handleCloseMenu}>
          <FaUserPlus className="text-hint group-hover:text-primary transition duration-300" size={22} />
          <span className='text-secondary group-hover:text-primary text-sm font-b ml-3.5'>Sign up</span>
        </div>
      </Link>
      <Link href='/help'>
