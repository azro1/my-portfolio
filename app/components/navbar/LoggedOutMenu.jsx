    ...
    <>
      <Link href='/'>
        <div className='flex items-center p-3 mb-1 bg-nightSky group hover:bg-softCharcoal' onClick={handleCloseMenu}>
          <FaHome className="text-accentRed" size={18} />
          <span className='text-stoneGray group-hover:text-frostWhite transition duration-300 text-base ml-3.5'>Home</span>
        </div>
      </Link>
      <Link href='/about'>
        <div className='flex items-center p-3 mb-1 bg-nightSky group hover:bg-softCharcoal' onClick={handleCloseMenu}>
          <FaInfoCircle className="text-accentRed" size={17} />
          <span className='text-stoneGray group-hover:text-frostWhite transition duration-300 text-base ml-3.5'>About</span>
        </div>
      </Link>
      <Link href='/contact'>
        <div className='flex items-center p-3 mb-1 bg-nightSky group hover:bg-softCharcoal' onClick={handleCloseMenu}>
          <FaEnvelope className="text-accentRed" size={16} />
          <span className='text-stoneGray group-hover:text-frostWhite transition duration-300 text-base ml-3.5'>Contact</span>
        </div>
      </Link>
      <Link href='/login'>
        <div className='flex items-center p-3 mb-1 bg-nightSky group hover:bg-softCharcoal' onClick={handleCloseMenu}>
          <FaSignInAlt className="text-accentRed" size={20} />
          <span className='text-stoneGray group-hover:text-frostWhite transition duration-300 text-base ml-3.5'>Login</span>
        </div>
      </Link>
      <Link href='/signup'>
        <div className='flex items-center p-3 mb-1 bg-nightSky group hover:bg-softCharcoal' onClick={handleCloseMenu}>
          <FaUserPlus className="text-accentRed" size={22} />
          <span className='text-stoneGray group-hover:text-frostWhite transition duration-300 text-base ml-3.5'>Sign up</span>
        </div>
      </Link>
      <Link href='/help'>
        <div className='flex items-center p-3 bg-nightSky group hover:bg-softCharcoal' onClick={handleCloseMenu}>
          <FaQuestionCircle className="text-accentRed" size={18} />
