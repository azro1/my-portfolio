...
const LoggedOutMenu = ({ handleCloseMenu }) => {
  return (
    <>
      ...
      <Link href='/contact'>
        <div className='flex items-center p-3 mb-1 bg-primary group hover:bg-white' onClick={handleCloseMenu}>
          <FaEnvelope className="text-accentRed group-hover:text-primary transition duration-300" size={16} />
          <span className='text-secondary group-hover:text-primary text-base ml-3.5'>Contact</span>
        </div>
      </Link>
      <Link href='/login'>
        <div className='flex items-center p-3 mb-1 bg-primary group hover:bg-white' onClick={handleCloseMenu}>
          <FaSignInAlt className="text-accentRed group-hover:text-primary transition duration-300" size={20} />
          <span className='text-secondary group-hover:text-primary text-base ml-3.5'>Login</span>
        </div>
      </Link>
      <Link href='/signup'>
        <div className='flex items-center p-3 mb-1 bg-primary group hover:bg-white' onClick={handleCloseMenu}>
          <FaUserPlus className="text-accentRed group-hover:text-primary transition duration-300" size={22} />
          <span className='text-secondary group-hover:text-primary text-base ml-3.5'>Sign up</span>
        </div>
      </Link>
      <Link href='/help'>
