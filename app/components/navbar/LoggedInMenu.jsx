  ...
  return (
    <>
      ...
      <div className='flex items-center p-3 group hover:bg-white cursor-pointer' onClick={handleCloseMenu}>
        <FaSignOutAlt className="text-secondary group-hover:text-primary transition duration-300" size={20} />
        <span className='text-white group-hover:text-primary text-sm font-b ml-3.5'>Logout</span>
      </div>
      </div>
      <Link href='/help'>
      <div className='flex items-center p-3 group hover:bg-white' onClick={handleCloseMenu}>
