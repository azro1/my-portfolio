...
const Footer = ({ showAuthFooter }) => {
  const socialLinks = (colorClass) => (
    <>
      <a className={colorClass} href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer"><FiLinkedin size={24} /></a>
      <a className={colorClass} href="https://github.com" target="_blank" rel="noopener noreferrer"><FiGithub size={24} /></a>
      <a className={colorClass} href="https://www.youtube.com" target="_blank" rel="noopener noreferrer"><FiYoutube size={24} /></a>
      <a className={colorClass} href="https://www.instagram.com" target="_blank" rel="noopener noreferrer"><FiInstagram size={24} /></a>
    </>
  );
  ...
  return (
    <footer className="w-full flex min-h-[120px] bg-slateOnyx">
