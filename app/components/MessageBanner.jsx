      ...
      <div className='w-full fixed top-0 left-0 text-center z-50 p-5'>
          <AnimatePresence>
              ...
              <motion.div
                  ...
                  className='error flex items-center justify-center gap-2.5 max-w-max mx-auto'
              >    
              ...
              {message.type === 'success' && 
                  <motion.div
                      ...
                      exit={{ y: -45, opacity: 0 }}
                      transition={{ delay: 0.2, duration: 0.3, type: 'tween' }}
                      className='success flex items-center justify-center gap-2.5 max-w-max mx-auto'
                  >
                      {iconSizes.map((obj, index) => (
                          <div className={`${obj.className} bg-white rounded-full`} key={index}>
              ...
              {message.type === 'info' && 
                  <motion.div
                      ...
                      exit={{ y: -45, opacity: 0 }}
                      transition={{ delay: 0.2, duration: 0.3, type: 'tween' }} 
                      className='info flex items-center justify-center gap-2.5 max-w-max mx-auto'
                  >
                      {iconSizes.map((obj, index) => (
                          <div className={`${obj.className} bg-white rounded-full`} key={index}>
