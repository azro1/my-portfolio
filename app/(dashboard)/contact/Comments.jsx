...
const Comments = ({ user }) => {
    ...
    return (
        <div className='place-self-start'>
            {user && (
                <div>
                    <h3 className='mb-2 text-xl font-b text-accentRed'>
                        Leave a Comment
                    </h3>
                    <form onSubmit={handleComment}>
                        ...
                        {commentError && <div className='error'>{commentError}</div>}
                            <button className='btn block mt-2 bg-accentRed'>{isLoading ? 'Adding...' : 'Add Comment'}</button>
                    </form>
                </div>
            )}
            ...
            {comments !== null && comments.length > 0 && (
                <div className='w-full sm:max-w-xl mt-20'>
                    <h3 className='text-xl font-b text-accentRed mb-8'>
                        Comments
                    </h3>
