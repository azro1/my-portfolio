        ...
        <div>
            <ul>
                <li className='flex gap-3 pb-3'>
                    <FaPhone size={20} className='text-hint' aria-label='Phone' />
                    <p>+447455 132 994</p>
                </li>
                <li className='flex gap-3 pb-3'>
                    <FaEnvelope size={20} className='text-hint' aria-label="Email" />
                    <p>azro1.development@gmail.com</p>
                </li>
                <li className='flex gap-3 pb-3'>
                    <FaMapMarkerAlt size={20} className='text-hint' aria-label="Address" />
