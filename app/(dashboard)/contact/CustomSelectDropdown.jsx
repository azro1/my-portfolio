    ...
    return (
        <>
            ...
            <div className="custom-select relative">
                ...
                {/* Dropdown options */}
                {dropdownOpen && (
                    <ul className="absolute w-full bg-white border-[1px] border-gray-300 border-opacity-55 mt-1 z-10" ref={dropDownRef}>
                        {options.map((option, index) => (
                            <li
                                key={index}
                                className="py-2 px-4 text-ashGray hover:bg-softGray cursor-pointer"
