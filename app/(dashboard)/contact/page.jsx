...
const Contact = async () => {
  ...
  return (
    <div className={`grid grid-flow-col auto-cols-fr gap-y-14 md:grid-cols-2 md:gap-x-6 ${user ? 'md:grid-rows-[minmax(_auto,_auto)_minmax(700px,_auto)]' : 'md:grid-rows-[minmax(180px,_auto)_minmax(700px,_auto)]'} relative top-10`}>
        ...
        <div className='row-start-3 col-start-1 col-span-2 md:row-start-2 md:col-start-1 md:col-span-1'>
          <div className='flex flex-col gap-14 h-full justify-evenly'>
              <ContactInfo />
              <AvailabilityInfo />
          </div>
        </div>
