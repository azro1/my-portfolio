      ...
      <div className="overflow-hidden">
        ...
        <div className="flex flex-wrap justify-center items-center gap-10 md:gap-12 relative">
          {services.map((service, index) => (
            ...
            >
              <div className="p-3 bg-charcoalGray shadow-[0_6px_8px_rgba(0,0,0,0.2)] w-max rounded-md transition-all transform hover:scale-105 md:p-4 md:shadow-[0_6px_8px_rgba(0,0,0,0.6)]">
