  ...
  return (
    <section>
      <div className='grid grid-cols-1 md:grid-cols-2 grid-auto-rows md:grid-rows-[repeat(auto-fill,_minmax(0,_375px))] gap-4 md:gap-16'>
          ...
          <div className="col-span-1 md:col-start-1 md:row-start-1 relative h-[375px] shadow-outer rounded-xl">
            <Image
          ...
          <div className="mt-20 md:mt-0 col-span-1 md:col-start-2 md:row-start-2 relative h-[375px] shadow-outer rounded-xl">
            <Image 
          ...
          <div className="mt-20 md:mt-0 col-span-1 md:col-start-1 md:row-start-3 relative h-[375px] shadow-outer rounded-xl">
            <Image
          ...
          <div className="mt-20 md:mt-0 col-span-1 md:col-start-2 md:row-start-4 relative h-[375px] shadow-outer rounded-xl">
            <Image
