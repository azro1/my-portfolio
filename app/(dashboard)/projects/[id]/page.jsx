  ...
  return (
    <div className="flex flex-col">
          <div className="main-container">
            <main>
              <div className="flex flex-col items-center pt-36 pb-20 md:p-0 md:h-screen md:min-h-[1154px]">
                <div className="w-full flex-grow flex items-center justify-center">
                  ...
                  <div className='flex flex-col justify-center gap-4 h-full relative'>
                    ...
                    <div className='flex flex-col gap-6'>
                      ...
                      <div className='min-h-[180px] max-w-[200px] relative bg-white md:hidden'>
