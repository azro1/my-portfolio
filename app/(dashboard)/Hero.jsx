    ...
    <section>
      <div className="block text-center lg:flex flex-row-reverse gap-16 items-center">
        ...
        <div className="flex-1 text-center mt-16 lg:mt-0">
          <h4 className="text-xl text-accentRed font-barlow">WEB DEVELOPER</h4>
          ...
          <Link className="group" href="#">
            <button className="btn bg-accentRed hover:filter hover:brightness-75 duration-300">DOWNLOAD CV</button>
          </Link>
        </div>
      </div>
    </section>
