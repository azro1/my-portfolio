      ...
      <div className="overflow-hidden">
        ...
        <div className="flex flex-wrap items-center justify-center max-w-[300px] mx-auto gap-6 lg:max-w-none lg:gap-12 lg:justify-around lg:px-1">
          {keySkills.map((skill, index) => (
            ...
            >
              <div className="p-3 w-max rounded-md shadow-[0_6px_8px_rgba(0,0,0,0.3)] transition-all transform hover:scale-105 bg-charcoalGray md:shadow-[0_6px_8px_rgba(0,0,0,0.6)] md:p-4">
