...
const About = () => {
  return (
    <div className="grid grid-cols-1 grid-auto-rows md:grid-rows-[repeat(auto-fill,_minmax(0,_340px))] md:md:grid-cols-2 gap-4 md:gap-x-16 md:gap-y-44">
        ...
        <div className="mt-20 md:mt-0 md:col-start-2 md:row-start-2 relative h-[340px] shadow-outer rounded-xl">
           <Image 
        ...
        <div className="mt-20 md:mt-0 md:col-start-2 md:row-start-5 relative h-[340px] shadow-outer rounded-xl">
          <Image
        ...
        <div className="mt-20 md:mt-0 relative h-[340px] shadow-outer rounded-xl">
          <Image
