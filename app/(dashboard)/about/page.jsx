    ...
    <div className="grid grid-cols-1 gap-y-6.25 md:gap-y-10.25">
      <div className="flex flex-col items-center md:flex-row md:justify-between md:items-end md:gap-8">
        ...
        <div className="flex flex-col text-center mt-16 md:mt-0 md:text-left md:w-full">
          <h2 className="subheading font-b text-accentRed pb-3">About Me</h2>
      ...
      <div className="flex flex-col-reverse text-center items-center md:flex-row md:gap-8">
        <div className="flex flex-col mt-16 md:mt-0 md:justify-center md:text-left md:w-full">
          <h2 className="subheading font-b text-accentRed pb-3">My History</h2>
      ...
      <div className="flex flex-col text-center gap-8">
        <h2 className="subheading font-b text-accentRed text-center">Key Skills</h2>
      ...
      <div className="flex flex-col items-center md:flex-row md:justify-between md:items-end md:gap-8">
        ...
        <div className="flex flex-col text-center mt-16 md:mt-0 md:text-left md:w-full">
          <h2 className="subheading font-b text-accentRed pb-3">Contributing</h2>
          ...
          <p className="leading-7">Check out my <a className="text-accentRed" href="https://github.com/azro1" target="_blank">GitHub</a> repository for a closer look at my community engagements and open-source contributions</p>
        </div>
      </div>
      ...
      <div className="flex flex-col-reverse text-center items-center md:flex-row md:gap-8">
        <div className="flex flex-col mt-16 md:mt-0 md:justify-center md:text-left md:w-full">
          <h2 className="subheading font-b text-accentRed pb-3">Teaching</h2>
          <p className="leading-7 pb-4">I'm passionate about sharing knowledge through my <a className="text-accentRed" href="https://www.youtube.com/channel/UCSK7zfwlgMq3r88lkchHsSw" target="_blank">YouTube channel</a> offering tutorials on web development, graphic design, and more. Teaching via video content broadens my reach, empowering others to explore these creative realms</p> 
        </div>
        <div className="w-full h-64 md:h-74 relative">
          <Image
      ...
      <div className="flex flex-col text-center items-center md:flex-row md:gap-8">
        ...
        <div className="flex flex-col mt-16 md:mt-0 md:justify-center md:text-left md:w-full">
          <h2 className="subheading font-b text-accentRed pb-3">My Interests</h2>
