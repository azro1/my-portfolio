...
const CompleteRegistration = () => {
    ...
    const handleUpdateProfile = async (e) => {
        ...
        if (!firstName) {
            ...
            setSaving(false)
            setError('Invalid phone number. Please enter a number between 7 and 15 digits.')
            setTimeout(() => setError(null), 2000)
            return
        }
    ...
    return (
        <>
            ...
            <div className='flex flex-col justify-center items-center my-4.5'>
                ...
                <h2 className='text-3xl leading-normal mb-8 font-eb text-accentRed'>Set Up Your Account</h2>
                    ...
                    <button className='btn block mt-5 bg-accentRed'>{isLoading ? 'Registering...' : 'Register'}</button>
