...
const History = () => {
  ...
  return (
    <section className="relative py-20 bg-nightSky text-frostWhite overflow-hidden">
      {/* Starry background */}
      ...
      <div className="sm:px-8 md:px-0 flex flex-col md:flex-row items-center justify-between relative z-10 max-w-full">
        <div className="w-full md:w-1/2 flex flex-col items-start mb-10 md:mb-0 transition-opacity duration-700" style={{ opacity: scrollPosition === 0 ? 0 : opacity }}>
          <h2 className="subheading font-bold mb-4 text-saddleBrown">
            My History
          </h2>
